...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <div class="row" style="margin-top:20%;">
                ...
                align-items-start mgn-list"> <div class="d-flex w-100 "> <h6
                class="mb-1">Manajemen Receptionist</h6> </div> </a> -->
                <div class="col-sm-12">
                    ...
                    <div class="list-group">
                        <a
                            ...
                            <span class="mb-1">Alamat : </span>
                                <span class="mb-1">Jl. Bunga Mawar 29B</span>
                            </div>
                            <div class="mgn-list"><span class="sm-font">Tlep : </span>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#header_title").text('Management Receptionist');
        });
    </script>